...
export const appRoot = document.getElementById('app-root') as HTMLDivElement | null;
export const appHeaderElement = document.querySelector('.app-header') as HTMLElement | null;
